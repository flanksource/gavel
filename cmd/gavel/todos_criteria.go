...
var todosCriteriaCmd = &cobra.Command{
	...
	Long: `Manage a TODO's acceptance criteria — the task-list items evaluated by
the TODO's fixture-backed definition of done. Subcommands: list, add, remove,
edit, generate (AI re-draft).`,
