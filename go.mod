module github.com/flanksource/gavel

go 1.26.1

require (
	github.com/flanksource/captain v0.0.51
...
require (
	...
	github.com/flanksource/clicky/aichat v1.21.58-0.20260823135047-e9ff84a33d81 // indirect
