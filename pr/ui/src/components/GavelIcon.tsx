...
const icons: Record<string, StaticIcon> = {
  ...
  'codicon:circle-large-outline': UiCircleOutline,
  ...
  'codicon:history': UiHistory,
  'codicon:hubot': UiHubot,
  'codicon:json': UiJson,
  'codicon:kebab-vertical': UiDotsVertical,
  'codicon:layers': UiLayers,
  'codicon:lightbulb': UiLightbulb,
  'codicon:link-external': UiLinkExternal,
  'codicon:list-flat': UiListFlat,
  'codicon:checklist': UiListDashes,
